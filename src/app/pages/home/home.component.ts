...
import {AppBarComponent} from "@brightlayer-ui/angular-components";
...
export class HomeComponent implements OnInit {
    ...
    collapsed = false;
    id: string;
    className: { name: string, index: number };
    element: HTMLElement;

  @ViewChild('bluiBar') appBar: AppBarComponent;
    ...
    ngOnInit(): void {
      this.changeScrollSource({ value: 'id' });
    }
    ...
    changeScrollSource(e: any): void {
        ...
        if (e.value === 'class') {
          this.id = undefined;
          this.className = { name: 'app-bar-container', index: 0 };
          this.element = undefined;
        }
        if (e.value === 'element') {
          this.id = undefined;
          this.className = undefined;
          this.element = document.getElementById('app-bar-id');
        }
